	...
	return (
		...
		>
			<div className={'flex flex-col gap-4'}>
				...
				<p
					className={
						'text-sm leading-tight tracking-tight text-color-text-chip-card 2xl:text-lg'
					}
				>
					{text}
				</p>
